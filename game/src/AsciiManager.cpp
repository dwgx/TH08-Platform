...
void AsciiManager::FUN_00422bb0(i32 idx, i32 interrupt)
{
...
void AsciiManager::SetIsGuiMode(ZunBool isGui)
{
    this->isGui = isGui;
}

void AsciiManager::SetScale(f32 scaleX, f32 scaleY)
{
    this->scaleX = scaleX;
    this->scaleY = scaleY;
}

void AsciiManager::SetBossMarkerPosition(i32 idx, D3DXVECTOR3 *position)
{
    this->bossMarkers[idx].pos = *position;
}
