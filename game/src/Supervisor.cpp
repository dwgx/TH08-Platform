...
u32 Supervisor::IsMinimumGraphicsMode()
{
    return (*(u32 *)&this->cfg.opts >> 4) & 1;
}

u32 Supervisor::IsDepthTestDisabled()
{
    return (*(u32 *)&this->cfg.opts >> 6) & 1;
}

u32 Supervisor::IsColorCompositingDisabled()
{
    return (*(u32 *)&this->cfg.opts >> 8) & 1;
}

u32 Supervisor::IsHUDRedrawEnabled()
{
    return (*(u32 *)&this->cfg.opts >> 12) & 1;
}
